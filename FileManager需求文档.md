...
| 重命名      | 单击   | 重命名选中文件     |
| 属性       | 单击   | 显示文件信息，文件大小，文件修改日期，文件路径     |
| 粘贴       | 单击    | 粘贴被复制或剪切的文件到当前文件编辑子面版     |
打开，打开方式，复制，剪切，删除，粘贴，永久删除，重命名，发送，复制路径，压缩，解压缩，详情，排序，创建文件，新建文件夹，显示隐藏文件
### 按键响应
...
| √     | 文件框选                                                                           | 功能     | 100% |
| √     | 网上邻居                                                                           | 功能     | 100% |
| √    | 撤销操作及Ctrl+Z热键                                                                | 功能      | 100% |
| √     | 支持可选择是否显示隐藏文件                                                            | 功能     | 100% |
| √    | Seafile文件/文件夹自动同步                                                           | 功能     | 100% |
| √     | Seafile显示文件目录列表盘                                                            | 功能     | 100% |
| √     | Seafile增加/解除同步文件夹                                                           | 功能     | 100% |
| √    | Seafile文件/文件夹的上传、下载                                                        | 功能     | 100% |
| √     | Owncloud文件/文件夹自动同步                                                          | 功能     | 100% |
| √    | Owncloud显示文件目录列表盘                                                           | 功能     | 100% |
| √     | Owncloud增加/解除同步文件夹                                                          | 功能     | 100% |
| √     | Owncloud文件/文件夹的上传、下载                                                       | 功能     | 100% |
...
| 开始时间  | 结束时间  | 内容 | 人员|
| ---- |------- |-------|:---------|
|2016.10.24| 2017.03.15|按照交付手册的要求，完成第一版文件管理器，并交付使用|小组全体成员|
